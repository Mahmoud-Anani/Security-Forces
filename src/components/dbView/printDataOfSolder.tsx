        ...
        (dataIndex) =>
          showOutput && (
            <div
              ref={contentRef}
              key={dataIndex}
              className={`sm:text-2xl text-3xl flex flex-col gap-4 relative left-[-3%] w-[740px] h-[1095px] z-10`}
            >
              <div className={`absolute z-10 top-[23.8%]`}>
                <p style={{direction:"rtl"}} className={`px-8 font-semibold text-black`}>{value}</p>
                <div
                  className={`text-center flex flex-col gap-[20px] mr-12 sticky sm:mt-[65px] mt-[85px] font-semibold text-black`}
                >
